'''
    We divide lr by 2 to be 2e-4, compared to fsdv2_nusc_2x_N_by_28_multi_samples.py
    We also use NMS thr 0.05
    Batch Size 6
'''

_base_ = [
    '../_base_/datasets/nusc-10class_N_by_28_multi_samples.py',
    # '../_base_/datasets/nusc-10class_N_by_28_multi_samples_concat_dataset.py',
    '../_base_/schedules/cyclic_20e.py',
    '../_base_/default_runtime_fsdv2.py',
]
...
model = dict(
    ...
    virtual_point_projector=dict(
        in_channels=106 + 64,#83 + 64 changed
        hidden_dims=[64, 64],
        norm_cfg=dict(type='naiveSyncBN1d'),
...
data = dict(
    samples_per_gpu=6, #bz==2,   8 initially
)
