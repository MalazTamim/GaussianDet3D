...
def parse_args():
    ...
    parser.add_argument(
        '--work-dir',
        default='Test_output',
        help='the dir to save test logs, copied config, and outputs')
...
def main():
    ...
    # work_dir is determined in this priority: CLI > default TEST_output
    ...
    if use_seq_code:
        from mmdet3d.apis.seq_training_apis import NuScenesSceneSequentialSampler
        from functools import partial
        from mmcv.parallel import collate
        sampler = NuScenesSceneSequentialSampler(dataset, shuffle_scenes=False)
    ...
    elif not cfg.model.test_cfg.get('sequential', False):
