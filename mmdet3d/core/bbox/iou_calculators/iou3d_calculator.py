...
def bbox_overlaps_3d(bboxes1, bboxes2, mode='iou', coordinate='camera'):
    ...
    """
     # Debugging prints
    print("Debugging bbox_overlaps_3d:")
    print("bboxes1 shape:", bboxes1.shape)
    print("bboxes2 shape:", bboxes2.shape)

    if bboxes1.size(-1) > bboxes2.size(-1):
        print("Trimming bboxes1 from", bboxes1.size(-1), "to", bboxes2.size(-1))
        bboxes1 = bboxes1[:, :bboxes2.size(-1)]
    
    print("Final bboxes1 shape:", bboxes1.shape)
    # print("bboxes2 shape:", bboxes2.shape)
